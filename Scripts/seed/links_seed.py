...
from Scripts.generated_files import generated_products_links
import json
import utils
...
def reduce_amount_of_products_links_based_on_pattern(grouped_paterns: list[str], treshold):
    ...
    with open('../dummy_data/filtered_products_links.json', 'w', encoding='utf-8') as json_file:
